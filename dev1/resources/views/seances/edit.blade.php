...
<form class="jumbotron mt-3 col-md-5" method="POST" action="{{ route('seance.update', $seance->id) }}">
    {{ csrf_field() }}
    {{method_field('PUT')}}
    ...
    <p class="mb-3">
        ...
        <input class="form-control" type="text" name="duree" id="duree" value="{{$seance->duree}}" required />
    </p>
