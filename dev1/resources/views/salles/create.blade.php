...
<form class="jumbotron mt-3 col-md-5" method="POST" action="{{ route('salle.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="capacite" id="capacite" value="" required />
        ...
        <div class="mb-3">
            ...
            <select class="form-control" type="" name="climatisation" id="climatisation" value="" required>
