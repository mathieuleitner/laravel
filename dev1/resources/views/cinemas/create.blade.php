...
<form class="jumbotron mt-3 col-md-5" method="POST" action="{{ route('cinema.store') }}">
        {{ csrf_field() }}
        <h1 class="display-4 font-italic">Le Formulaire des CINEMAS</h1>

        <p class="mb-3">
            <label for="nom_cinema">Nom</label>
            <input class="form-control" type="text" name="nom_cinema" id="nom_cinema" value="" required />
        ...
        <p class="mb-3">
            ...
            <input class="form-control" type="text" name="arrondissement" id="arrondissement" value="" required />
